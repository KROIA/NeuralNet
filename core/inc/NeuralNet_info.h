...
/// USER_SECTION_END
	...
	public:
		...
		static constexpr int versionMajor				= NeuralNet_VERSION_MAJOR;
		static constexpr int versionMinor				= NeuralNet_VERSION_MINOR;
		static constexpr int versionPatch				= NeuralNet_VERSION_PATCH;
		...
		static constexpr const char* name				= NeuralNet_LIBRARY_NAME;
